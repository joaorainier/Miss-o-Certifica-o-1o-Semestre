...
def ao_fechar():
    resposta = messagebox.askyesno('Sair', 'Deseja mesmo fechar o programa?')
    if resposta:
        main_janela.destroy()
...
def menu_tecnicos():
    ...
    search_button = tk.Button(tec_janela, text="Buscar", bg="#03063b", fg="#edb200", activebackground="#45A29E",
                     activeforeground="#112D32", font=("Tahoma", 10, "bold"), command=search)
...
def menu_ferramentas():
    ...
    search_button = tk.Button(fer_janela, text="Buscar", bg="#03063b", fg="#edb200", activebackground="#45A29E",
                     activeforeground="#112D32", font=("Tahoma", 10, "bold"), command=search)
    search_button.place(x=545, y=310)
